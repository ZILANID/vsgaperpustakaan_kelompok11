		...
		<div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="card-body">
				...
				<div class="row col-lg-12">
					<div class="col-lg-5">
						<a target="_blank" href="controller/PeminjamanController.php?action=cetakdatapeminjaman&id=<?php echo $_GET['id']?>" type="button" class="btn btn-sm btn-outline-info btn-icon-text"><i class="ti-printer btn-icon-append"> Cetak Bukti Peminjaman</i></a>
					</div>
					<div class="col-lg-7" align="right">
					  <h4 class="card-title">DETAIL DATA PEMINJAMAN</h4>
					  <p class="card-description">
						Perpustakaan Online | <code>.data-Detail Peminjaman</code>
					  </p>
					</div>
				</div>
				...
				<div class="col-12 row">
					  <div class="col-6">
						...
						<div class="row">
							<div class="col-md-4 p-2 bg-light text-dark">Data Anggota</div>
					  ...
					  <div class="col-6">
						...
						<div class="row">
							<div class="col-md-4 p-2 bg-light text-dark">Data Buku</div>
						...
						<div class="row">
							<div class="col-md-12 p-2 bg-light text-dark" align="right">
								<a href="index.php?p=peminjaman"><button align="right" class="btn btn-sm btn-warning btn-icon-text">Kembali</button></a>
							</div>
						</div>
					  </div>
