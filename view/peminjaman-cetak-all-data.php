...
<title>Cetak Data All Peminjaman Buku | Sistem Perpustakaan Online</title>
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<div>
<center><h3>DATA TRANSAKSI PEMINJAMAN BUKU</h3></center>
<center><p>Transaksi Peminjaman Buku per: <?php echo date("l j F Y h:i:s A") . "<br>"; ?></p></center>
				...
				<div class="row col-lg-12">
					...
					<div class="col-lg-7" align="right">
					  ...
					  <p class="card-description">
						Perpustakaan Online | <code>.data-Transaksi Peminjaman Sedang Berlangsung</code>
					  </p>
					</div>
				</div>
