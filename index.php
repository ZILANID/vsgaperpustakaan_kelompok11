  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.php"><!--<p><b>SISTEM PERPUSTAKAAN</b></p>--><img src="asset/image/logoperpustakaan.png" class="mr-2" alt="logo"/></a>
...
>>>>>>> 5dd9358ad42a289bceaab16c20855c159747ff6b
		  ...
		  <hr>
		  <center>Asset Bootstrap dimenu bawah ini</center>
		  <!-- ASSET PAGE -->
          <li class="nav-item">
